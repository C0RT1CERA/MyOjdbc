...
<body>
    ...
    <section class="sec2">
<%
int ed_place = Integer.parseInt(request.getParameter("edplace"));
try
{
...
<form action="editData.jsp">
            ...
            %>
                <td><%= i %> </td>
				<td > <input style="font-weight: bolder; background-color: #9b299b; color: #cfbfd6;" type="text" placeholder="<%= rollNo %>" name="rollNo"> </td>
				<td > <input style="font-weight: bolder; background-color: #9b299b; color: #cfbfd6;" type="text" placeholder="<%= name %>" name="name"> </td>

                <td style="display:flex;  ">
                    <div class="delete-icon" style="justify-content: space-evenly; border: 0px solid white; margin-top: 20px;">
                        <input type="submit" name="btchoice" value="Update">
                        <input type="submit" name="btchoice" value="Cancel">
                        <input type="hidden" name="memAd" value="<%= memAddr%>">
